...
#FX3G2 Directories
export codebase_dir=C:/Work/Code
export bfw_dir=C:/Work/Code/fx3g2_docs_main/psvp_fw/validation/burnin
export bfwd_dir=C:/Work/Code/fx3g2_docs_main_usb3_debug/psvp_fw/validation/burnin

alias bfw='cd $bfw_dir'
alias codebase='cd $codebase_dir'
alias bfwd='cd $bfwd_dir'

#Simon Firmware location
export sfw_dir=C:/Work/Code/fx3g2_docs_main/psvp_fw/fx3g2_vfw
alias sfw='cd $sfw_dir'

#PSOC6 generic Project
export sumobot_dir=C:/Work/Code/generic/sumobot
